...
const Silabus = () => {
  ...
  return (
    <div>
        ...
        <a href="/" className="w-50 h-10 bg-fuchsia-400 rounded-3xl transform hover:scale-105 transition-all duration-300 hover:text-fuchsia-400 hover:font-bold hover:bg-fuchsia-200"></a>
        </div>
    </div>
  ) 
}
